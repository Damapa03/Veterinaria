...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.emailInput.setEchoMode(QLineEdit.EchoMode.Password)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.aceptatButton.setText(QCoreApplication.translate("MainWindow", u"Iniciar sesi\u00f3n", None))
        self.loginTitle.setText(QCoreApplication.translate("MainWindow", u"Iniciar Sesi\u00f3n", None))
        ...
        self.passwordLabel_2.setText(QCoreApplication.translate("MainWindow", u"\u00bfNo tienes cuenta? Registrate", None))
    # retranslateUi
