...
################################################################################
## Form generated from reading UI file 'veterinarios_crear.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.formLayoutWidget.setGeometry(QRect(40, 30, 352, 139))
        ...
        self.dniLabel = QLabel(self.formLayoutWidget)
        self.dniLabel.setObjectName(u"dniLabel")

        self.formLayout.setWidget(0, QFormLayout.LabelRole, self.dniLabel)

        self.dniInput = QLineEdit(self.formLayoutWidget)
        self.dniInput.setObjectName(u"dniInput")

        self.formLayout.setWidget(0, QFormLayout.FieldRole, self.dniInput)
        ...
        self.formLayoutWidget_2.setGeometry(QRect(390, 48, 331, 121))
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", u"Crear Veterinario", None))
